...
const contactJSON = [
  {
    svg:<svg xmlns="https://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-telephone-fill" viewBox="0 0 16 16">
  ...
  {
    svg:<svg xmlns="https://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
  ...
  {
    svg:<svg xmlns="https://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-envelope-fill" viewBox="0 0 16 16">
...
function Contactdetails(props) {
  return(
    <>
      <h2 className="contactHeading">Reach out to us or send us a feedback along with your contact details</h2>
      <br />
      {
